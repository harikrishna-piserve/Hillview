...
/**
 * Provides dynamic permissions for Asset of different types.
 *
...
class AssetPermissions{
   ...
   *
   * @return array
   *   The Asset by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (Asset::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\asset_management\Entity\Asset $type
   *   The Asset type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(Asset $type) {
    $type_id = $type->id();
